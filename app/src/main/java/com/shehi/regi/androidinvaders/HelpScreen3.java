...
public class HelpScreen3 extends GLScreen {
    ...
    public HelpScreen3(Game game) {
        ...
        textString = "5. Getting hit by an alien";
        textString1 = "missile loses you 1 life";
        textString2 = "6. Colliding with an alien";
        textString3 = "terminates the game";
    }
    ...
    public void present(float deltaTime) {
        ...
        Assets.font.drawText(batcher, textString1, 70, 240-30);

        Assets.font.drawText(batcher, textString2, 30, 240-30-70);
        Assets.font.drawText(batcher, textString3, 100, 240-30-70-30);
