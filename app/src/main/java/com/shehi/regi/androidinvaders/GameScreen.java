...
import com.shehi.regi.androidinvaders.World.WorldListener;
...
public class GameScreen extends GLScreen {
    ...
    public GameScreen(Game game) {
        ...
        worldListener = new WorldListener() {
            ...
            @Override
            public void hithit() {
                Assets.playSound(Assets.hithitSound);
            }
        };
        ...
        shotBounds = new Rectangle(0, 0, 480, 260);
        lastScore = 0;
        lastLives = world.ship.lives;
        scoreString = "lives:" + lastLives + " score:"
                + lastScore;
    }
    ...
    private void updateRunning(float deltaTime) {
        ...
        if (world.ship.lives != lastLives || world.score != lastScore) {
            ...
            scoreString = "lives:" + lastLives + " score:" + lastScore;
        }
        if (world.isGameOver()) {
            state = GAME_OVER;
