...
public class HelpScreen4 extends GLScreen {
    ...
    public HelpScreen4(Game game) {
        ...
        textString = "7. For every 50 points your";
        textString1 = "firing speed is doubled";
    }
    ...
    public void present(float deltaTime) {
        ...
        Assets.font.drawText(batcher, textString, 30, 240-50);
        Assets.font.drawText(batcher, textString1, 70, 240-30-50);
